...
Derived outputs from NYC technology spending transaction data (FY2016–2025).
...
1. **Budget code names vs actual spending** — Codes named "Information Technology" or "Management Information Systems" may fund personnel rather than technology vendors, and vice versa. Classification here is based on actual vendor payments, not code names.
