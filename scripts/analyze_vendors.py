#!/usr/bin/env python3
"""
Analyze NYC FY2024 spending data to classify vendors by sector.
"""
...
# Load the data
print("=" * 80)
print("NYC DIGITAL SPENDING - Initial Analysis")
print("=" * 80)
...
print("Then we'll summarize NYC's digital services spending.")
